...
public class StudentController {
    ...
    public StudentResponse getByFirtsNameAndLastName (@PathVariable String firstName, @PathVariable String lastName) {
        return new StudentResponse(studentService.getByFirstNameAndLastName(firstName, lastName));
    }

    @GetMapping("getByFirstNameOrLastName/{firstName}/{lastName}")
    public List<StudentResponse> getByFirtsNameOrLastName (@PathVariable String firstName, @PathVariable String lastName) {
    ...
    public List<StudentResponse> getByFirtsNameIn (@RequestBody InQueryRequest inQueryRequest) {
    ...
    public String updateStudentWithJpl (@PathVariable Long id, @PathVariable String firstName){
